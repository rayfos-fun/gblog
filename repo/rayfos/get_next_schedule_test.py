...
class TestGetNextSchedule(unittest.TestCase):
  ...
  def test_weekly_today_future(self):
    ...
    result = get_next_schedule(target_time, target_weekday=target_weekday, now=self.now)
    self.assertEqual(result, expected)
  ...
  def test_monthly_same_month(self):
    ...
    result = get_next_schedule(target_time, target_day_of_month=target_day, now=self.now)
    self.assertEqual(result, expected)
  ...
  def test_monthly_year_rollover(self):
    ...
    result = get_next_schedule(target_time, target_day_of_month=target_day, now=dec_now)
    self.assertEqual(result, expected)
